...
### Folder 1: `simulation`
- **Description**: The simulation validation for the evolution of debris clouds from explosive breakup, corresponding to the first and second part of the Results section in the paper.
- **Files**:
    ...
    - `plot_SC_X.m`: This script generates plots that display the comparison between the reference values and inferred values, as well as the JS divergence.
...
- **Description**: Validates the core support of the O2UDI method using TLE data from the Cosmos 1408 breakup event. Corresponds to the third part of the Results section in the paper.
- **Files**:
    ...
    - `cosmos_1408`: Contains the TLE data of debris pieces generated from the Cosmos 1408 breakup. All debris data was obtained from the website [https://www.space-track.org/](https://www.space-track.org/).
    - Other files: Custom functions called during the execution of the program.
...
### Folder 4: `supple`
- **Description**: Plots the figures for the Supplementary Materials, which correspond to the figures in the supplementary document.
...
### Folder 4: `supple`
1. Run the several `.m` files in the folder separately.
