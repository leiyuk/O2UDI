...
_, cosmos_2251_20100101 = extract_cosmos_debris_norad_ids(Path(r"tle_snapshot_output/tle_snapshot_20090510_000000_UTC.3le"))
_, cosmos_2251_20200101 = extract_cosmos_debris_norad_ids(Path(r"tle_snapshot_output/tle_snapshot_20190510_000000_UTC.3le"))
...
# 指定多个 NORAD ID
NORAD_IDS = cosmos_2251_20100101_20200101.copy()

# 查询时间范围，按 UTC 解释
# 保留 START_TIME_UTC <= EPOCH <= END_TIME_UTC 的全部 TLE
START_TIME_UTC = "2009-05-10 00:00:00"
END_TIME_UTC = "2019-05-10 00:00:00"
